...
**`src/styles.css`** – for shadcn/ui apps, this is generated by `npx shadcn@latest init` and contains Tailwind + theme variables. For plain CSS apps, add your own styles directly.
...
- **Use [shadcn/ui](https://ui.shadcn.com/)** (recommended) or `@jappyjan/even-realities-ui` for the browser settings page. See [browser UI](browser-ui.md).
